...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->decimal('price_cost_erp',$precision=8, $scale=2)->nullable();
            $table->decimal('price_sell_erp',$precision=8, $scale=2)->nullable();
            $table->decimal('price_base',$precision=8, $scale=2)->nullable();
