...
<div class="row">
    <div class="col-12 col-sm-6 col-md-2" id="divAbrirBar">
        <div class="info-box mb-3">
            ...
            <button href="javascript:void(0)" class="btn btn-sm" role="button" id="abrirBar" title="Abrir Bar"
                aria-label="Abrir Bar">
    ...
    <div class="col-12 col-sm-6 col-md-3" id="divFecharBar">
        <div class="info-box mb-3">
            <button href="javascript:void(0)" class="btn btn-sm" role="button" id="fecharBar" title="Fechar Bar"
                aria-label="Fechar Bar">
